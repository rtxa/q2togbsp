...
class GenesisFace {
    // TODO anyway this doesn't matter too much, this is Engine dependant and
    // the code for converting doesn't care about this, editor must implement a
    // different flag according to the engine TexFlags is just everything about
    // a face, that could be shared with another face or more...
    enum class TexFlags : int {
        ...
        Translucent = (1 << 4),  // Hint to the engine that's not solid
